 ...
 <div id="wrap" >
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel">
                    <?php echo Html::anchor('admin/answers', 'Answers') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/inputtypes', 'Input Types') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/optionchoices', 'Option Choices') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/optiongroups', 'Option Groups') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/questionoptions', 'Question Option') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/questions', 'Questions') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/surversections', 'Survey Section') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/surveyheaders', 'Survey Headers') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/surveycomments', 'Survey Comments') ?>
                </li>

                <li class="panel">
                    <?php echo Html::anchor('admin/unitofmeasures', 'Measures') ?>
                </li>
                ...
                <li class="panel">
                    <?php echo Html::anchor('admin/usersurveysections', 'User Survey Section') ?>
                </li>
